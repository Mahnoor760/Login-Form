...
<br>
<br>
<h1>MY PROJECTS OF PHP</h1>
<div class="ag-format-container">
  <div class="ag-courses_box">
    <div class="ag-courses_item">
      <a href="quran.php" class="ag-courses-item_link">
    ...
    <div class="ag-courses_item">
      <a href="hadithindex.php" class="ag-courses-item_link">
        <div class="ag-courses-item_bg"></div>
    ...
    <div class="ag-courses_item">
      <a href="fileuploading.php" class="ag-courses-item_link">
        <div class="ag-courses-item_bg"></div>
